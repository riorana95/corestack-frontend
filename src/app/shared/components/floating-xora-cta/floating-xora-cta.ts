...
/**
 * Sticky floating "Enter Xora" pill.
 *
 ...
 * - On click: routes to `/xora`. Auth guard handles the
 *   redirect to `/xora/login` if needed.
 */
@Component({
  selector: 'app-floating-xora-cta',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './floating-xora-cta.html',
  changeDetection: ChangeDetectionStrategy.Eager,
  styleUrl: './floating-xora-cta.scss',
})
export class FloatingXoraCta {
